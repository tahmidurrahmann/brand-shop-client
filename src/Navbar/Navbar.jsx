...
function Navbar(props) {
    ...
    const navLinks = <div className="flex flex-col md:flex-row justify-center items-center gap-5">
        ...
        >
            <span className="flex justify-center items-center gap-1"><FaCartShopping />Add Product</span>
        </NavLink>
        <NavLink
            to="/myCart"
            className={({ isActive, isPending }) =>
        ...
        >
            <span className="flex justify-center items-center gap-1"><MdOutlinePlaylistAdd />My Cart</span>
        </NavLink>
        {user?.email ? <div>
            <Button
                id="basic-button"
        ...
        <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
            <Typography variant="h6" sx={{ my: 2 }}>
                <div className="flex items-center justify-center">
                    ...
                    <h1 className="text-2xl font-extrabold">ream<span>Tech</span></h1>
                </div>
            </Typography>
            <Divider />
            <List>
                    ...
                    <Toolbar>
                        ...
                        >
                            <div className="flex items-center">
                                <img className="w-[36px]" src="https://i.ibb.co/ZWNKnHg/Letter-D-logo-design-template-with-geometric-shape-style-on-transparent-background-PNG-removebg-prev.png" alt="" />
                                <h1 className="text-2xl font-extrabold">ream<span className="">Tech</span></h1>
                            </div>
                        </Typography>
